...
export default {
  ...
  methods: {
    ...mapMutations({
      ...
      newMessage: "users/newMessage"
    }),
    ...mapActions({
      socketEmit: "users/socketEmit",
      joinRoom: "users/joinRoom",
      leftRoom: "users/leftRoom",
      addTypingUser: "users/addTypingUser",
      displayTypingStatus: "users/displayTypingStatus"
    }),
    exit() {
      this.leftRoom();
      this.$router.push("/appChat/?message=leftChat");
    }
  },
  created() {

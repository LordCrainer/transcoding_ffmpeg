...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"%s - client-service","title":"client-service","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"servicios varios"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_imagenURL_737bf4f1 === 'function') {
    await nuxt_plugin_imagenURL_737bf4f1(app.context, inject)
  }
